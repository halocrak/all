...
print('\033[33;1m[+] 1-  Report snapchat  ')
kurd = input('\033[33;1m[+] halbzhera==> : \x1b[0m')
if kurd == '1':
    time.sleep(1)
    print('''
[+] Spam
''')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req2:
            print('\033[1;32m[+]Report Hate snap Sent')
        else:
            print('\033[1;32m[+] Report Has Been Sent')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req3:
            print('[+] Report snapchat sent')
        else:
            print('\033[1;32m[+] Report snap Sent')
