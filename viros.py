...
print('\033[1;31;40m[+] 1-  Report instgarm spam ')
kurd = input('\033[1;31;40m[+] halbzhera==> : \x1b[0m')
if kurd == '1':
    time.sleep(1)
    print('''
[+] Spam
''')
    ...
    time.sleep(1)
    print("")
    id1 = input('\033[1;31;40m[+] User  ==> : \x1b[0m')
...
if kurd2 == '1':
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req5:
            print('\033[1;32m[+] Report instagram Sent')
        else:
            print('\033[1;32m[+] Report instagram Sent')
